...
jQuery(window).load(function() {
    ...
    jQuery('.isures-radio-variable input').each(function(index, element) {
        ...
        let select = jQuery('select[name="' + thisName + '"] option[value="' + thisVal + '"]').is(":checked");
        if (select) {
    ...
    jQuery(".product-isures").each(function() {
        var active_current = parseInt(jQuery(this).find('.isures-sub-title').attr('current-active'));

        let offset = parseInt(jQuery(this).find(".load-more").attr("offset"));
        var offset_reset = parseInt(jQuery(this).find(".load-more").attr("offset"));
        var show_area = jQuery(this).find(".loadmore-wrap");

        var btn_loadmore = jQuery(this).find(".load-more");
        var ppp = parseInt(jQuery(this).find(".load-more").attr("data_ppp"));
        var btn_tab = jQuery(this).find(".load-product-tab");

        jQuery(this).find('.isures-sub-title a[cat_id_tab="' + active_current + '"]').addClass('active');
        var minus_prod_document = parseInt(jQuery(this).find('.load-product-tab.active').attr('count_post')) - parseInt(jQuery(this).find('.product-small.col').length);
        if (minus_prod_document <= 0 || isNaN(minus_prod_document)) {
            btn_loadmore.hide();
        }
        ...
        jQuery(btn_tab).click(function() {
            ...
            var item_ph = jQuery(this).closest('.product-isures').find('.product-small.col');

            if (parseInt(jQuery(this).attr('count_post')) > ppp) {
                btn_loadmore.show();
            } else {
                btn_loadmore.hide();
            }
            ...
            jQuery(this).addClass("active");
            var btn_in_tab = jQuery(this).attr("cat_id_tab");
            offset = offset_reset;
            jQuery.ajax({
                type: "post",
                dataType: "html",
                url: isures_vars.ajaxurl,
                data: {
                    action: "load_tab",
                    id_tab: btn_in_tab,
                    offset: offset,
                ...
                beforeSend: function(response) {
                    item_ph.append('<div class="isures-ph--item"><div class="ph-col-12"><div class="ph-picture"></div><div class="ph-row"><div class="ph-col-6 big"></div><div class="ph-col-4 empty big"></div><div class="ph-col-2 big"></div><div class="ph-col-4"></div><div class="ph-col-8 empty"></div><div class="ph-col-6"></div><div class="ph-col-6 empty"></div><div class="ph-col-12"></div></div></div></div>');
                    btn_loadmore.css('opacity', '0');
                },

                complete: function(response) {
                    jQuery('.isures-ph--item').remove();
                    jQuery('html, body').animate({
                        scrollTop: jQuery(show_area).offset().top - 100,
                    }, 'slow');
                ...
                if (response) {
                    ...
                    btn_loadmore.attr("cat_id", btn_in_tab);
                    btn_loadmore.css('opacity', '1');
                }

            });

            if (jQuery(window).width() < 1024) {
                jQuery(this).closest('ul.isures-sub-title').hide();
                jQuery('.isures-menu--mobile_tab').removeClass('active');
            }
            return false;
        });
        ...
        jQuery(btn_loadmore).click(function() {
            ...
            var cat_id = btn_loadmore.attr("cat_id");
            var item_ph_lm = jQuery(this).closest('.product-isures').find('.product-small.col');
            jQuery.ajax({
                type: "post",
                dataType: "html",
                url: isures_vars.ajaxurl,
                ...
                beforeSend: function(response) {
                    item_ph_lm.append('<div class="isures-ph--item"><div class="ph-col-12"><div class="ph-picture"></div><div class="ph-row"><div class="ph-col-6 big"></div><div class="ph-col-4 empty big"></div><div class="ph-col-2 big"></div><div class="ph-col-4"></div><div class="ph-col-8 empty"></div><div class="ph-col-6"></div><div class="ph-col-6 empty"></div><div class="ph-col-12"></div></div></div></div>');
                    btn_loadmore.css('opacity', '0');
                },
                complete: function(response) {
                    jQuery('.isures-ph--item').remove();
                    btn_loadmore.css('opacity', '1');
                    var minus_prod = parseInt(btn_loadmore.closest('.product-isures').find('.load-product-tab.active').attr('count_post')) - parseInt(btn_loadmore.closest('.product-isures').find('.product-small.col').length);
                    if (minus_prod <= 0) {
                        btn_loadmore.hide();
                    }
                ...
                jQuery('html, body').animate({
                    scrollTop: jQuery(btn_loadmore).offset().top - 100,
                }, 'slow');
                if (response) {
                    show_area.append(response);
                    offset = offset + ppp;
...
jQuery('body').on('click', '.isures-menu--mobile_tab', function(e) {
    jQuery(this).closest('.isures-heading').find('ul.isures-sub-title').stop().slideToggle('fast');
    jQuery(this).toggleClass('active');
    e.stopPropagation();
});

jQuery('body').on('click', 'ul.isures-sub-title', function(e) {
    e.stopPropagation();
...
jQuery(document).click(function() {
    ...
    if (jQuery(window).width() < 1024) {
        jQuery('ul.isures-sub-title').slideUp('fast');
        jQuery('.isures-menu--mobile_tab').removeClass('active');
    }
...
jQuery('body').on('click', '.isures-btt', function(event) {
...
jQuery(window).scroll(function() {
    ...
    if (jQuery(this).scrollTop() > showAfter) {
        jQuery('.isures-btt').fadeIn('fast');
    } else {
        jQuery('.isures-btt').fadeOut('fast');
    }
...
jQuery(document).ready(function() {
    ...
    jQuery('.isures--step--billing .col-inner').append('<div class="wrap-load"><div class="loader"></div></div>');
    jQuery('.shipping__list_item , ul.nav-steps--wrap li a[href="#isures-tab--billing').on('click', function() {
        jQuery('.isures--step--billing .col-inner .wrap-load').animate({
            opacity: 1,
            scrollTop: jQuery('ul.nav-steps--wrap').offset().top,
        }, 500, function() {

            jQuery('.isures--step--billing .wrap-load').show();
            jQuery.ajax({
                type: 'post',
                url: isures_vars.ajaxurl,
                dataType: 'html',
                data: {
                    action: 'reset_price_isures',
                },
                beforeSend: function() {

                },
                success: function(response) {
                    jQuery('.isures-reset--price').html(response);
                    jQuery('.isures--step--billing .col-inner .wrap-load').hide();
                },
    ...
    jQuery('body').on('click', '.wc_payment_method', function() {
        ...
        jQuery(this).children('.payment_box').slideDown('fast');
        jQuery('.payment_box').hide();
    });

    let emtpy_address = jQuery('.woocommerce-error.message-wrapper');
    if (emtpy_address.length) {
        jQuery('.isures-content#isures-tab--complete').show().siblings().hide();
        jQuery('ul.nav-steps--wrap a[href="#isures-tab--complete"]').parent('li').addClass('active').siblings().removeClass('active');
    }
    jQuery('.isures-tab--wrap ul.nav-steps--wrap li a').on('click', function(e) {
        var currentAttrValue = jQuery(this).attr('href');

        jQuery('.isures-content' + currentAttrValue).show().siblings().hide();
    ...
    jQuery('.btn-step--billing').on('click', function() {
        jQuery('ul.nav-steps--wrap li a[href="#isures-tab--billing"]').trigger('click');

        jQuery('html, body').animate({
            scrollTop: jQuery('ul.nav-steps--wrap').offset().top - 50,
        }, 'slow');


        return false;
    });
    jQuery('.prev-step--cart').on('click', function() {
        jQuery('ul.nav-steps--wrap li a[href="#isures-tab--cart"]').trigger('click');
        if (jQuery(window).width() < 1024) {
            jQuery('html, body').animate({
                scrollTop: jQuery('ul.nav-steps--wrap').offset().top - 50,
            }, 'slow');
    ...
    jQuery('.btn-step--complete').on('click', function() {
        jQuery('ul.nav-steps--wrap li a[href="#isures-tab--complete"]').trigger('click');
        return false;
    });

    jQuery('body').on('click', '.textcode', (function() {
        jQuery('.coupon-hidden').slideDown('fast');
    }));
    jQuery('body').on('click', '.remove-label', function() {
...
jQuery(document).ready(function ($) {
  ...
  $('.items-price').click(function() {
    var items_price = $(this).attr('data-price');
	var items_toprice = $(this).attr('data-toprice');
	var item_ph_lm = $('.mh-product-set-price').find('.product-small.col');
    $('.items-price').removeClass('active');
    ...
    $.ajax({
      ...
      data: {
		...
		'items_toprice' : items_toprice
      },

      beforeSend: function(){
       // $('.spinner').addClass('before-ajax');
        //$('.mh-product-set-price').addClass('before-ajax');
        item_ph_lm.append('<div class="isures-ph--item"><div class="ph-col-12"><div class="ph-picture"></div><div class="ph-row"><div class="ph-col-6 big"></div><div class="ph-col-4 empty big"></div><div class="ph-col-2 big"></div><div class="ph-col-4"></div><div class="ph-col-8 empty"></div><div class="ph-col-6"></div><div class="ph-col-6 empty"></div><div class="ph-col-12"></div></div></div></div>');
      },

      success: function(response) {
		    jQuery('.isures-ph--item').remove();
        $('.mh-product-set-price').html(response);
        //$('.spinner').removeClass('before-ajax');
        //$('.mh-product-set-price').removeClass('before-ajax');
